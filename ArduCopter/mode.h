...
class ModeTest_1017 : public Mode {

public:
    // inherit constructor
    using Mode::Mode;
    Number mode_number() const override { return Number::TEST_1017; }
...
protected:
    ...
    const char *name() const override { return "Test_1017"; }
    const char *name4() const override { return "Test_1017"; }
...
private:
    ...
    //my function for test auto_attack
    Vector3f path[10];
    int path_num;
    void for_static_target();
